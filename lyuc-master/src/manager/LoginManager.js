...
export default class LoginManager {
    ...
    constructor() {
        ...
        (async() => {
            try {
                ...
                console.log('===Error in login_push = ', e)
            }
        })();
    ...
    async loginWithPassword(user, password) {
        let temp_username = user.split('@');
        this.username = temp_username[0] + '@dateapp.lynxdate.n2.voximplant.com';
